function Catamarca2Dias() {
  ...
  const title =
    "Qué Hacer en Catamarca en 2 Días | Itinerario";

  const description =
    "Itinerario para conocer Catamarca en 2 días. Ideas de recorridos, paisajes y experiencias para organizar una escapada y aprovechar mejor tu estadía.";

  const canonicalUrl =
    "https://mttransfers.com/catamarca-2-dias";
